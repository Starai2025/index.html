# Resume Sample Inventory

Current resume samples pulled from the workspace:

1. `johnathan-right-partner-support-resume.md`
   - Based on the available Dexian Partner Support / AI SaaS Partner Operations resume set.
